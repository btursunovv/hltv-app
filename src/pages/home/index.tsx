          ...
          <div id="center-content">
            <div id="main-event">
              <div id="main-event-logo">
                <img
                  src="https://static.hltv.org/images/eventLogos/5524.png"
                  alt="main event logo"
                />
              </div>
            ...
            <div id="main-news">
              <img
                src="https://img-cdn.hltv.org/gallerypicture/Wwm-EbCWqTTbul6hmuUcE2.png?ixlib=java-2.1.0&s=04cafc0dc764724e9c2b46c11fded8de"
                alt="main notice"
              />
            </div>
            <h3>Today's news</h3>
            ...
            <div id="today-matches">
              ...
              <div id="today-matches-box">
                {fakeData.matches.map((match) => (
                  <Match teams={match.teams} time={match.time} />
                ))}
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div id="match-results">
                {fakeData.matchesResults.map((match) => (
                  <MatchResult teams={match.teams} title={match.title} />
                ))}
              </div>
            </div>
            <div>
